        ...
        <Container>
          <Row>
            ...
            <Col xs={12} sm={8} md={10}>
              {account.length > 0 && <TransferToken address={account} />}
              {account.length > 0 && <ChangeToken address={account} />}
              {account.length > 0 && <BuyToken address={account} />}
              {account.length > 0 && <TxLists address={account} />}
            </Col>
          </Row>
        </Container>
      </div>
